...
const ItemCount = ({stock, onAdd}) => {
    ...
    return (
        <div className="container">
            ...
            <div className="row">
                <div className="col">
                    {itemAdded ? <Link to={"/cart"} className="btn btn-light">Finalizar Compra</Link> : <button type="button" className="btn btn-light" onClick={addToCart}>Agregar a Pedido</button>}
                </div>
            </div>
        </div>        
    )
